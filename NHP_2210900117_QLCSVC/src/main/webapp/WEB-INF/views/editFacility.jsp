...
<head>
    ...
    <title>Chỉnh sửa Cơ sở Vật chất</title>
...
<body>
    ...
    <header class="header text-white">
        <h1>Chỉnh sửa Cơ sở Vật chất</h1>
    </header>
    ...
    <div class="container my-5 animate">
        <form action="updateFacility" method="post">
            ...
            <input type="text" name="status" value="${facility.status}" required>
            <label>ID Phòng:</label>
            <input type="number" name="roomId" value="${facility.roomId}" required>
            <input type="submit" value="Cập nhật">
        </form>
        <a href="facilities" class="btn btn-custom mt-3"><i class="fas fa-arrow-left"></i> Quay lại</a>
    </div>
