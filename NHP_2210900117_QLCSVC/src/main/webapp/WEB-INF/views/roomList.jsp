...
<body>
    ...
    <div class="container my-5 animate">
        <c:if test="${sessionScope.user.role == 'Admin' || sessionScope.user.role == 'Manager'}">
            <a href="addRoom" class="btn btn-custom mb-3"><i class="fas fa-plus"></i> Thêm mới</a>
        </c:if>
        <table>
            <tr>
                <th>ID</th>
            ...
            <c:forEach var="room" items="${roomList}">
                <tr>
                    ...
                    <td>
                        <c:if test="${sessionScope.user.role == 'Admin' || sessionScope.user.role == 'Manager'}">
                            <a href="updateRoom?id=${room.id}"><i class="fas fa-edit"></i> Sửa</a> |
                            <a href="deleteRoom?id=${room.id}" 
