...
<body>
    ...
    <div class="container my-5 animate">
        <c:if test="${sessionScope.user.role == 'Admin' || sessionScope.user.role == 'Manager'}">
            <a href="addLog" class="btn btn-custom mb-3"><i class="fas fa-plus"></i> Thêm mới</a>
        </c:if>
        <table>
            <tr>
                <th>ID</th>
            ...
            <c:forEach var="log" items="${logList}">
                <tr>
                    ...
                    <td>
                        <c:if test="${sessionScope.user.role == 'Admin' || sessionScope.user.role == 'Manager'}">
                            <a href="updateLog?id=${log.id}"><i class="fas fa-edit"></i> Sửa</a> |
                            <a href="deleteLog?id=${log.id}" 
